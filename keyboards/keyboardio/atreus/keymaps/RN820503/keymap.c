...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    */
    ...
    KC_SCLN, KC_1,    KC_2,    KC_3,    KC_EQL,                    _______, OSMSFT,  OSMCMD,  OSMOPT,  OSMCTL,
    KC_GRV,  KC_4,    KC_5,    KC_6,    KC_BSLS, _______, _______, _______, ___x___, ___x___, ___x___, ___x___,
